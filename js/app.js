...
function appFeats () {
    ...
    //ui
    const brkfstLabel = document.querySelector('#brkfast-label');
    const lunchLabel = document.querySelector('#lunch-label');
    const dinnerLabel = document.querySelector('#dinner-label');
    const snacksLabel = document.querySelector('#snacks-label');
